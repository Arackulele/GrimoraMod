...
public class EmbalmingFluid : GrimoraTargetSlotItem
{
	...
	public static ConsumableItemData NewEmbalmingFluid(GameObject Model)
	{
		...
		ConsumableItemData data = ConsumableItemManager.New(GUID, "Embalming Fluid", "The Embalming Fluid, pour it over a card and itll gain one health and attack.", HahaL, typeof(EmbalmingFluid), Model)
