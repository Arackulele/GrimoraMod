...
public class SliveredBank : ConsumableItem
{
	...
	public static ConsumableItemData NewSliveredBank(GameObject Model)
	{
		...
		ConsumableItemData data = ConsumableItemManager.New(GUID, "Slivered Hoggy Bank", "The Slivered Hoggy bank, gain 2 extra bones up to three times.", HahaL, typeof(SliveredBank), Model)
