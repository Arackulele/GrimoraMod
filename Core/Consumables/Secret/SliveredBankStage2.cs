...
public class SliveredBank2 : ConsumableItem
{
	...
	public IEnumerator replaceItem()
	{
		...
		RunState.Run.consumables.Add(GrimoraPlugin.GrimoraItemsSecret.Find(g => g.name.Contains("Slivered Hoggy Bank3")).name);
